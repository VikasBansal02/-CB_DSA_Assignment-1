...
class BinaryTree
{
    ...
    public void vikas_bottomView()
    {
        
        vikas_bottomView(this.vikas_root);
   ...
   private void vikas_bottomView(TreeNode vikas_root) {
	   ...
	   while(!vikas_q.isEmpty()){
		   ...
		   if(vikas_r.vikas_val.vikas_left != null && vikas_r.vikas_val.vikas_left.vikas_val != -1) 
			   vikas_q.add(new vikas_Pair( vikas_r.vikas_data-1, vikas_r.vikas_val.vikas_left ));
		    
		    
		   if(vikas_r.vikas_val.vikas_right != null && vikas_r.vikas_val.vikas_right.vikas_val != -1)
